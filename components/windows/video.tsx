...
export default function Video({ setFullScreen, isFullscreen }) {
    ...
    <div className="relative">
      <div className="relative">
        ...
        <div className="absolute bottom-1 right-0 left-0 flex gap-2 px-2">
          <button
            className="border-black flex-shrink-0 border bg-white focus:outline-none font-chicago active:inverted active:border-white h-4 w-4 flex items-center justify-center"
            onClick={() => {
              if (video.current?.paused) {
                video.current.play();
                setIsPlaying(true);
