...
/** Destination = (NOT source) AND destination (bit clear). */
...
/** Destination = source AND destination (NOT inverted source, then BIC). */
...
/** Destination = (NOT pattern) AND destination (bit clear). */
...
/** Destination = pattern AND destination (NOT inverted pattern, then BIC). */
